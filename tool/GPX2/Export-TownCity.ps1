function Export-MunicipalityTownsGpx {
    [CmdletBinding()]
    param (
...
#    $towns = $townResult.elements | Where-Object { $_.tags.name -and $_.tags.place -notin @("city", "town", "village", "suburb") }
    ...
    $gpx.SetAttribute("creator", "PowerShell-Nominatim")
    ...
    foreach ($town in $towns) {
        ...
        $trkpt.SetAttribute("lat", $tLat.ToString())
        $trkpt.SetAttribute("lon", $tLon.ToString())
