function Convert-PsmToModule {
    ...
    function Convert-TypeExtension {
        ...
        if ($extensionLines.Count -gt 0) {
            ...
            New-Item -ItemType Directory -Path (Separate-Path $extPath) -Force | Out-Null
    ...
    $rootAst.FindAll({
        ...
        Convert-Function $_ $isExported $outRoot
    }

    $assignments = Get-ScriptBlockAssignments $rootAst
    Convert-TypeExtension $rootAst $assignments $outRoot
